...
<main>
    ...
    <?php if (isset($_GET['idProduit']) && !empty($_GET['idProduit'])) :
        $idProduit = $_GET['idProduit'];
        $product = getProduct($idProduit);
    ...
    <?php else : ?>
        <div class="not_found container">
            <div class="left">
                <h2>Sorry, the product not found</h2>
                <p>The link you followed probably broken, or the product has been removed</p>
                <a href="index.php">Go Home</a>
            </div>
            <img src="img/page_not_found.png" alt="Illustration page not found">
        </div>
